...
automodel_lib = import_local_module("trainer_engine.automodel_lib")
...
model_path, model, model_config, tokenizer = automodel_lib.AutoJAXModelForCausalLM.from_pretrained(
